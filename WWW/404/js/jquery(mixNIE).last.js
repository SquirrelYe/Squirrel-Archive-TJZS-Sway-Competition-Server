      ...
      switch (
        ...
        case "object":
          ...
          if (rep && "object" == typeof rep)
            for (u = rep.length, n = 0; u > n; n += 1)
              "string" == typeof rep[n] &&
                ((r = rep[n]),
                (o = str(r, f)),
                o && i.push(quote(r) + (gap ? ": " : ":") + o));
          else
            for (r in f)
...
var BJ_REPORT = (function (t) {
  ...
  var e = [],
    ...
    r = function (t, e) {
      return (
        Object.prototype.toString.call(t) === "[object " + (e || "Object") + "]"
      );
    },
    o = function (t) {
      var e = typeof t;
        ...
        for (; e.length; ) {
          ...
          if (r(n.ignore, "Array"))
            for (var a = 0, s = n.ignore.length; s > a; a++) {
              var g = n.ignore[a];
              if (
                (r(g, "RegExp") && g.test(i[1])) ||
                (r(g, "Function") && g(u, i[1]))
              ) {
                o = !0;
                break;
              }
          ...
          o ||
            (n.combo ? p.push(i[0]) : c(n.report + i[2] + "&_t=" + +new Date()),
            n.onReport && n.onReport(n.id, u));
        }
        var y = p.length;
        if (y) {
          var d = function () {
    ...
    y = {
      push: function (t) {
        return Math.random() >= n.random
          ? y
          : (e.push(o(t) ? i(t) : { msg: t }), g(), y);
      },
      report: function (t) {
      ...
      info: function (t) {
        return t
          ? (o(t) ? (t.level = 2) : (t = { msg: t, level: 2 }), y.push(t), y)
          : y;
      },
      debug: function (t) {
        return t
          ? (o(t) ? (t.level = 1) : (t = { msg: t, level: 1 }), y.push(t), y)
          : y;
      },
      init: function (t) {
        ...
        return (
          r &&
            (/qq\.com$/gi.test(window.location.hostname) &&
              (n.url || (n.url = "//badjs2.qq.com/badjs"),
              n.uin ||
                (n.uin = parseInt(
  ...
  return (
    "undefined" != typeof console &&
      console.error &&
      setTimeout(function () {
        var t = ((location.hash || "").match(/([#&])BJ_ERROR=([^&$]+)/) ||
          [])[2];
        t &&
          console.error(
            "BJ_ERROR",
  ...
  (function (t) {
    if (t.BJ_REPORT) {
      var e,
            ...
            try {
              ...
              if (
                ...
                u.stack &&
                  console &&
                  console.error &&
                  console.error("[BJ-REPORT]", u.stack),
                !e)
              ) {
                var i = t.onerror;
                (t.onerror = function () {}),
        ...
        a = function (t) {
          return function () {
            for (var e, n = [], r = 0, o = arguments.length; o > r; r++)
              (e = arguments[r]), u(e) && (e = i(e)), n.push(e);
        ...
        s = function (t, e) {
          return function () {
            for (var n, r, o = [], a = 0, f = arguments.length; f > a; a++)
              (n = arguments[a]),
...
!(function (e, t) {
    ...
    if (B.isArray(t))
      B.each(t, function (t, i) {
        n || Wt.test(e)
          ? r(e, i)
          : f(
              e + "[" + ("object" == typeof i || B.isArray(i) ? t : "") + "]",
              i,
              n,
              r
            );
  ...
  function p(e, n, r, i, o, a) {
    ...
    for (
      var s, l = e[o], u = 0, c = l ? l.length : 0, f = e === nn;
      c > u && (f || !s);
      u++
    )
      (s = l[u](n, r, i)),
        "string" == typeof s &&
          (!f || a[s]
            ? (s = t)
            : (n.dataTypes.unshift(s), (s = p(e, n, r, i, s, a))));
  ...
  function h(e) {
    return function (t, n) {
      if (("string" != typeof t && ((n = t), (t = "*")), B.isFunction(n)))
        for (
          var r, i, o, a = t.toLowerCase().split(Qt), s = 0, l = a.length;
          l > s;
          s++
        )
          (r = a[s]),
      ...
      ? ("border" !== n &&
          B.each(i, function () {
            n || (r -= parseFloat(B.css(e, "padding" + this)) || 0),
              "margin" === n
                ? (r += parseFloat(B.css(e, n + this)) || 0)
                : (r -= parseFloat(B.css(e, "border" + this + "Width")) || 0);
          }),
        r + "px")
      : ((r = St(e, t, t)),
  ...
  function g(e, t) {
    t.src
      ...
      : B.globalEval(
          (t.text || t.textContent || t.innerHTML || "").replace(Ct, "/*$0*/")
        ),
  ...
  function y(e) {
    B.nodeName(e, "input")
      ...
      : "getElementsByTagName" in e &&
        B.grep(e.getElementsByTagName("input"), v);
  }
  function v(e) {
        ...
        if (((i = i[n] = B.extend({}, r)), o)) {
          ...
          for (var a in o)
            for (var s = 0, l = o[a].length; l > s; s++)
              B.event.add(
                t,
                a + (o[a][s].namespace ? "." : "") + o[a][s].namespace,
                o[a][s],
                o[a][s].data
              );
        }
  ...
  function S(e) {
    ...
    if (
      ...
      for (s = 0; s < g.length; s++)
        (o = g[s]),
          o.origType.replace(G, "") === e.type
            ? h.push(o.selector)
            : g.splice(s--, 1);
      for (
        i = B(e.target).closest(h, e.currentTarget), l = 0, u = i.length;
        u > l;
        l++
      )
          ...
          (o = g[s]),
            c.selector !== o.selector ||
              ...
              ("mouseenter" === o.preType || "mouseleave" === o.preType) &&
                ((e.type = o.preType),
                (r = B(e.relatedTarget).closest(o.selector)[0]),
                r && B.contains(a, r) && (r = a)),
              (!r || r !== a) &&
      ...
      return (
                  ...
                  if (i[1])
                    return (
                      ...
                      a
                        ...
                        : ((a = s.buildFragment([i[1]], [l])),
                          (e = (a.cacheable ? s.clone(a.fragment) : a.fragment)
                            .childNodes)),
                      s.merge(this, e)
                    );
                  ...
                  (r = l[n]),
                    ...
                    l !== i &&
                      (f && i && (s.isPlainObject(i) || (o = s.isArray(i)))
                        ? (o
                            ? ((o = !1), (a = r && s.isArray(r) ? r : []))
                            : (a = r && s.isPlainObject(r) ? r : {}),
                          (l[n] = s.extend(f, a, i)))
                        : i !== t && (l[n] = i));
            return l;
          }),
        s.extend({
          noConflict: function (t) {
            return (
              e.$ === s && (e.$ = u), t && e.jQuery === s && (e.jQuery = l), s
            );
          },
          isReady: !1,
          readyWait: 1,
          ...
          parseJSON: function (t) {
            return "string" == typeof t && t
              ? ((t = s.trim(t)),
                e.JSON && e.JSON.parse
                  ? e.JSON.parse(t)
                  : g.test(t.replace(y, "@").replace(v, "]").replace(b, ""))
          ...
          uaMatch: function (e) {
            ...
            var t =
              ...
              T.exec(e) ||
              w.exec(e) ||
              (e.indexOf("compatible") < 0 && N.exec(e)) ||
              [];
        ...
        (i = s.uaMatch(A)),
        i.browser &&
          ((s.browser[i.browser] = !0), (s.browser.version = i.version)),
          ...
          : M.attachEvent &&
            (a = function () {
              "complete" === M.readyState &&
                (M.detachEvent("onreadystatechange", a), s.ready());
            }),
        s
      );
    })(),
  ...
  B.extend({
                    ...
                    B.isFunction(o)
                      ? function () {
                          (i = o.apply(this, arguments)),
                            i && B.isFunction(i.promise)
                              ? i.promise().then(r.resolve, r.reject)
                              : r[a + "With"](this === n ? r : this, [i]);
                        }
                      : r[a]
                  );
                }
    ...
    when: function (e) {
      ...
      if (i > 1) {
        for (; i > r; r++)
          n[r] && B.isFunction(n[r].promise)
            ? n[r].promise().then(t(r), a.reject)
            : --o;
        o || a.resolveWith(a, n);
      ...
      if (
        ...
        M.defaultView &&
          ...
          (a.reliableMarginRight =
            0 ===
            (parseInt(
              (M.defaultView.getComputedStyle(o, null) || { marginRight: 0 })
                .marginRight,
              10
            ) || 0))),
        (c.innerHTML = ""),
        ...
        for (h in { submit: 1, change: 1, focusin: 1 })
          (p = "on" + h),
            (m = p in g),
            m ||
              (g.setAttribute(p, "return;"), (m = "function" == typeof g[p])),
            (a[h + "Bubbles"] = m);
  ...
  B.extend({
    ...
    hasData: function (e) {
      return (
        (e = e.nodeType ? B.cache[e[B.expando]] : e[B.expando]), !!e && !j(e)
      );
    },
      ...
      if (B.acceptData(e)) {
        ...
        return (
          ...
          ("object" == typeof n || "function" == typeof n) &&
            (i ? (c[f][s] = B.extend(c[f][s], n)) : (c[f] = B.extend(c[f], n))),
          (o = c[f]),
          i && (o[s] || (o[s] = {}), (o = o[s])),
          r !== t && (o[B.camelCase(n)] = r),
          "events" !== n || o[n]
            ? (l ? ((a = o[n]), null == a && (a = o[B.camelCase(n)])) : (a = o),
              a)
            : o[s] && o[s].events
        );
      }
    ...
    removeData: function (e, t, n) {
      if (B.acceptData(e)) {
        ...
        if (
          t &&
          ((r = n ? a[s][i] : a[s]),
          r && (r[t] || (t = B.camelCase(t)), delete r[t], !j(r)))
        )
          return;
    ...
    B.fn.extend({
      data: function (e, n) {
        ...
        if ("undefined" == typeof e) {
          if (this.length && ((r = B.data(this[0])), 1 === this[0].nodeType))
            for (var i, o = this[0].attributes, a = 0, s = o.length; s > a; a++)
              (i = o[a].name),
                0 === i.indexOf("data-") &&
                  ((i = B.camelCase(i.substring(5))), L(this[0], i, r[i]));
          return r;
        }
        if ("object" == typeof e)
        ...
        return (
          (l[1] = l[1] ? "." + l[1] : ""),
          n === t
            ? ((r = this.triggerHandler("getData" + l[1] + "!", [l[0]])),
              r === t &&
                this.length &&
                ((r = B.data(this[0], e)), (r = L(this[0], e, r))),
              r === t && l[1] ? this.data(l[0]) : r)
            : this.each(function () {
                var t = B(this),
                  r = [l[0], n];
    ...
    B.extend({
      _mark: function (e, n) {
        e &&
          ((n = (n || "fx") + "mark"),
          B.data(e, n, (B.data(e, n, t, !0) || 0) + 1, !0));
      },
    ...
    B.fn.extend({
      ...
      promise: function (e, n) {
        ...
        for (
          ...
          (i =
            B.data(a[s], u, t, !0) ||
            ((B.data(a[s], c, t, !0) || B.data(a[s], f, t, !0)) &&
              B.data(a[s], u, B._Deferred(), !0))) && (l++, i.done(r));
        return r(), o.promise();
      },
    });
  var W,
  ...
  B.fn.extend({
      ...
      return this.each(
        B.isFunction(e)
          ...
          : function () {
              if ("string" === n)
                for (
                  var i, o = 0, a = B(this), s = t, l = e.split(X);
                  (i = l[o++]);
    ...
    hasClass: function (e) {
      for (var t = " " + e + " ", n = 0, r = this.length; r > n; n++)
        if (
          1 === this[n].nodeType &&
          (" " + this[n].className + " ").replace($, " ").indexOf(t) > -1
        )
          return !0;
      return !1;
    },
    val: function (e) {
      ...
      if (!arguments.length)
        return i
          ? ((n = B.valHooks[i.nodeName.toLowerCase()] || B.valHooks[i.type]),
            n && "get" in n && (r = n.get(i, "value")) !== t
              ? r
              : ((r = i.value),
                "string" == typeof r ? r.replace(z, "") : null == r ? "" : r))
          : t;
      ...
      return this.each(function (r) {
        ...
        1 === this.nodeType &&
          ...
          (n =
            B.valHooks[this.nodeName.toLowerCase()] || B.valHooks[this.type]),
          (n && "set" in n && n.set(this, i, "value") !== t) ||
            (this.value = i));
      });
    },
  }),
    B.extend({
              ...
              if (
                !(
                  ...
                  (l.parentNode.disabled &&
                    B.nodeName(l.parentNode, "optgroup"))
                )
              ) {
      ...
      removeAttr: function (e, t) {
        ...
        1 === e.nodeType &&
          ...
          B.attr(e, t, ""),
          e.removeAttribute(t),
          Y.test(t) && (n = B.propFix[t] || t) in e && (e[n] = !1));
      },
      attrHooks: {
        type: {
          set: function (e, t) {
      ...
      prop: function (e, n, r) {
        ...
        var o,
          ...
          s = 1 !== i || !B.isXMLDoc(e);
        return (
          s && ((n = B.propFix[n] || n), (a = B.propHooks[n])),
          r !== t
            ? a && "set" in a && (o = a.set(e, r, n)) !== t
              ? o
              : (e[n] = r)
            : a && "get" in a && null !== (o = a.get(e, n))
            ? o
            : e[n]
        );
      },
        ...
        tabIndex: {
          get: function (e) {
            ...
            return n && n.specified
              ? parseInt(n.value, 10)
              : U.test(e.nodeName) || (J.test(e.nodeName) && e.href)
              ? 0
              : t;
          },
        },
    ...
    (R = {
      get: function (e, n) {
        var r;
        return B.prop(e, n) === !0 ||
          ((r = e.getAttributeNode(n)) && r.nodeValue !== !1)
          ? n.toLowerCase()
          : t;
      },
      set: function (e, t, n) {
      ...
      ((W = B.valHooks.button =
        {
          ...
          set: function (e, t, n) {
            ...
            return (
              r || ((r = M.createAttribute(n)), e.setAttributeNode(r)),
              (r.nodeValue = t + "")
            );
          },
        }),
    ...
    B.each(["radio", "checkbox"], function () {
      B.valHooks[this] = B.extend(B.valHooks[this], {
        set: function (e, t) {
          return B.isArray(t)
            ? (e.checked = B.inArray(B(e).val(), t) >= 0)
            : void 0;
        },
      });
    });
  ...
  (B.event = {
            ...
            (s.handle = u =
              function (e) {
                return "undefined" == typeof B ||
                  ...
                  ? t
                  : B.event.handle.apply(u.elem, arguments);
              }),
          (u.elem = e),
          (n = n.split(" "));
        for (var c, f, d = 0; (c = n[d++]); ) {
          (a = o ? B.extend({}, o) : { handler: r, data: i }),
            c.indexOf(".") > -1
              ? ((f = c.split(".")),
                (c = f.shift()),
                (a.namespace = f.slice(0).sort().join(".")))
              : ((f = []), (a.namespace = "")),
            (a.type = c),
          ...
          p ||
            ((p = l[c] = []),
            (h.setup && h.setup.call(e, i, f, u) !== !1) ||
              (e.addEventListener
                ? e.addEventListener(c, u, !1)
                : e.attachEvent && e.attachEvent("on" + c, u))),
            h.add &&
              (h.add.call(e, a), a.handler.guid || (a.handler.guid = r.guid)),
            p.push(a),
            (B.event.global[c] = !0);
        }
        e = null;
          ...
          if (
            ...
            if (r) {
              ...
              for (s = 0; s < d.length; s++)
                (p = d[s]),
                  (l || c.test(p.namespace)) &&
                    (B.event.remove(e, h, p.handler, s), d.splice(s--, 1));
    ...
    trigger: function (n, r, i, o) {
      var a,
        ...
        l = [];
      if (
        (s.indexOf("!") >= 0 && ((s = s.slice(0, -1)), (a = !0)),
        s.indexOf(".") >= 0 && ((l = s.split(".")), (s = l.shift()), l.sort()),
        (i && !B.event.customEvent[s]) || B.event.global[s])
      ) {
        if (
          ((n =
            "object" == typeof n
          ...
          return void B.each(B.cache, function () {
            ...
            t &&
              t.events &&
              t.events[s] &&
              B.event.trigger(n, r, t.handle.elem);
          });
        ...
        if (!n.isDefaultPrevented()) {
          ...
          if (
            !(
              (p._default && p._default.call(i.ownerDocument, n) !== !1) ||
              ("click" === s && B.nodeName(i, "a")) ||
              !B.acceptData(i)
            )
          ) {
            try {
    ...
    special: {
      ...
      live: {
        add: function (e) {
          B.event.add(
            this,
            E(e.origType, e.selector),
            B.extend({}, e, { handler: S, guid: e.handler.guid })
          );
        },
        remove: function (e) {
  ...
  var nt = function (e) {
      ...
      (e.type = e.data),
        t !== this &&
          (t && (n = B.contains(this, t)),
          n || (B.event.handle.apply(this, arguments), (e.type = r)));
    },
    rt = function (e) {
        ...
        setup: function () {
          return B.nodeName(this, "form")
            ...
            : (B.event.add(this, "click.specialSubmit", function (e) {
                var t = e.target,
                  n =
                    B.nodeName(t, "input") || B.nodeName(t, "button")
                      ? t.type
                      : "";
                ("submit" === n || "image" === n) &&
                  B(t).closest("form").length &&
                  A("submit", this, arguments);
              }),
    ...
    var it,
      ...
      at = function (e) {
        ...
        if (K.test(i.nodeName) && !i.readOnly) {
          if (
            ((n = B._data(i, "_change_data")),
            (r = ot(i)),
            ("focusout" !== e.type || "radio" !== i.type) &&
              B._data(i, "_change_data", r),
            n === t || r === n)
          )
            return;
          (null != n || r) &&
            ((e.type = "change"),
            (e.liveFired = t),
            B.event.trigger(e, arguments[1], i));
        }
      };
    (B.event.special.change = {
      filters: {
        ...
        click: function (e) {
          ...
          ("radio" === n || "checkbox" === n || B.nodeName(t, "select")) &&
            at.call(this, e);
        },
        keydown: function (e) {
          var t = e.target,
            n = B.nodeName(t, "input") ? t.type : "";
          ((13 === e.keyCode && !B.nodeName(t, "textarea")) ||
      ...
      toggle: function (e) {
        var t = arguments,
          ...
          i = function (n) {
            ...
            return (
              B.data(this, "lastToggle" + e.guid, i + 1),
              n.preventDefault(),
  ...
  B.each(["live", "die"], function (e, n) {
    B.fn[n] = function (e, r, i, o) {
      ...
      for (
        ...
        if (
          ((s = G.exec(a)),
          (l = ""),
          s && ((l = s[0]), (a = a.replace(G, ""))),
          "hover" !== a)
        )
          if (
            ((u = a),
            st[a] ? (e.push(st[a] + l), (a += l)) : (a = (st[a] || a) + l),
            "live" === n)
          )
    ...
    (function () {
        ...
        for (var a = 0, s = r.length; s > a; a++) {
          ...
          if (l) {
            ...
            for (l = l[e]; l; ) {
              ...
              if (
                (1 === l.nodeType && !o && ((l.sizcache = n), (l.sizset = a)),
      ...
      var c = function (e, t, n, i) {
        ...
        do
          if (
            (r.exec(""), (s = r.exec(N)), s && ((N = s[3]), w.push(s[1]), s[2]))
          ) {
            p = s[3];
            break;
          }
        ...
        if (w.length > 1 && d.exec(e))
          ...
          (!i &&
            ...
            ((h = c.find(w.shift(), t, T)),
            (t = h.expr ? c.filter(h.expr, h.set)[0] : h.set[0])),
          t)
        )
          for (
            h = i
        ...
        if (
          (u || (u = l), u || c.error(g || e), "[object Array]" === o.call(u))
        )
          if (x)
            if (t && 1 === t.nodeType)
              for (v = 0; null != u[v]; v++)
                u[v] &&
                  (u[v] === !0 ||
                    (1 === u[v].nodeType && c.contains(t, u[v]))) &&
                  n.push(l[v]);
            else
              for (v = 0; null != u[v]; v++)
      ...
      (c.uniqueSort = function (e) {
        ...
        (c.filter = function (e, n, r, i) {
          for (
            var o, a, s = e, l = [], u = n, d = n && n[0] && c.isXML(n[0]);
            e && n.length;
          ...
          for (var t, n = "", r = 0; e[r]; r++)
            (t = e[r]),
              3 === t.nodeType || 4 === t.nodeType
                ? (n += t.nodeValue)
                : 8 !== t.nodeType && (n += c.getText(t.childNodes));
          return n;
        }),
        (function () {
            ...
            M.getElementById(n) &&
              ((f.find.ID = function (e, n, r) {
                if ("undefined" != typeof n.getElementById && !r) {
                  ...
                  return i
                    ? i.id === e[1] ||
                      ("undefined" != typeof i.getAttributeNode &&
          ...
          if (
            ...
            f.order.splice(1, 0, "CLASS"),
              (f.find.CLASS = function (e, t, n) {
                return "undefined" == typeof t.getElementsByClassName || n
                  ? void 0
                  : t.getElementsByClassName(e[1]);
              }),
              (e = null);
          }
        })(),
  ...
  B.fn.extend({
    ...
    closest: function (e, t) {
      ...
      if (B.isArray(e)) {
        ...
        if (o && e.length) {
          ...
          for (; o && o.ownerDocument && o !== t; ) {
            for (s in l)
              (a = l[s]),
                (a.jquery ? a.index(o) > -1 : B(o).is(a)) &&
                  i.push({ selector: s, elem: o, level: u });
            (o = o.parentNode), u++;
          }
        }
        return i;
      ...
      for (n = 0, r = this.length; r > n; n++)
        for (o = this[n]; o; ) {
          ...
          if (
            ((o = o.parentNode),
            !o || !o.ownerDocument || o === t || 11 === o.nodeType)
          )
            break;
        }
      return (
        (i = i.length > 1 ? B.unique(i) : i), this.pushStack(i, "closest", e)
      );
    },
    index: function (e) {
      return e
    ...
    B.extend({
      ...
      dir: function (e, n, r) {
        for (
          var i = [], o = e[n];
          o && 9 !== o.nodeType && (r === t || 1 !== o.nodeType || !B(o).is(r));
    ...
    B.fn.extend({
      ...
      remove: function (e, t) {
        for (var n, r = 0; null != (n = this[r]); r++)
          (!e || B.filter(e, [n]).length) &&
            (!t &&
              1 === n.nodeType &&
              (B.cleanData(n.getElementsByTagName("*")), B.cleanData([n])),
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          for (
            1 === e.nodeType && B.cleanData(e.getElementsByTagName("*"));
            e.firstChild;
        ...
        if (this[0]) {
          if (
            ...
            for (var c = 0, f = this.length, d = f - 1; f > c; c++)
              r.call(
                n ? w(this[c], o) : this[c],
                i.cacheable || (f > 1 && d > c) ? B.clone(a, !0, !0) : a
              );
          }
          u.length && B.each(u, g);
        }
    ...
    B.extend({
      ...
      cleanData: function (e) {
        for (
          ...
          if (
            (!r.nodeName || !B.noData[r.nodeName.toLowerCase()]) &&
            (n = r[B.expando])
          ) {
            ...
            s
              ? delete r[B.expando]
              : r.removeAttribute && r.removeAttribute(B.expando),
              delete i[n];
          }
      },
    });
      ...
      style: function (e, n, r, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          ...
          if (
            ...
            return;
          if (
            ("number" === a && !B.cssNumber[s] && (r += "px"),
            !(u && "set" in u && (r = u.set(e, r)) === t))
          )
            try {
              l[n] = r;
            } catch (c) {}
        ...
        set: function (e, t) {
          ...
          (n.zoom = 1),
            (t >= 1 &&
              ...
              (n.filter = Dt.test(o) ? o.replace(Dt, i) : o + " " + i);
        },
      }),
    B(function () {
      ...
      ((B.expr.filters.hidden = function (e) {
        ...
        return (
          ...
          (!B.support.reliableHiddenOffsets &&
            "none" === (e.style.display || B.css(e, "display")))
        );
      }),
      ...
      load: function (e, n, r) {
        ...
        n &&
          (B.isFunction(n)
            ? ((r = n), (n = t))
            : "object" == typeof n &&
              ((n = B.param(n, B.ajaxSettings.traditional)), (a = "POST")));
        var s = this;
        return (
          B.ajax({
            url: e,
        ...
        return this.map(function () {
          ...
          .filter(function () {
            return (
              this.name &&
              !this.disabled &&
              (this.checked || Kt.test(this.nodeName) || zt.test(this.type))
            );
          })
          .map(function (e, t) {
            var n = B(this).val();
    ...
    B.each(["get", "post"], function (e, n) {
      B[n] = function (e, r, i, o) {
        return (
          ...
          B.ajax({ type: n, url: e, data: r, success: i, dataType: o })
        );
      };
    }),
    B.extend({
      ...
      ajaxSetup: function (e, t) {
        return (
          t ? d(e, B.ajaxSettings) : ((t = e), (e = B.ajaxSettings)), d(e, t), e
        );
      },
      ajaxSettings: {
        url: qt,
      ...
      ajax: function (e, n) {
        function r(e, n, r, a) {
          if (2 !== N) {
              ...
              if (
                (m.ifModified &&
                  ((T = C.getResponseHeader("Last-Modified")) &&
                    (B.lastModified[i] = T),
                  (w = C.getResponseHeader("Etag")) && (B.etag[i] = w)),
                304 === e)
              )
                (E = "notmodified"), (f = !0);
              else
            ...
            (C.status = e),
              ...
              (x = t),
              d &&
                y.trigger("ajax" + (f ? "Success" : "Error"), [
                  C,
                  m,
                  f ? p : h,
                ]),
        ...
        if (
          ...
          m.data &&
            ...
            (m.data = B.param(m.data, m.traditional)),
          p(nn, m, n, C),
          2 === N)
        )
          return !1;
        if (
          ...
          !m.hasContent &&
            (m.data &&
              ((m.url += (Yt.test(m.url) ? "&" : "?") + m.data), delete m.data),
            (i = m.url),
            m.cache === !1))
        ) {
          var E = B.now(),
          ...
          m.url =
            S + (S === m.url ? (Yt.test(m.url) ? "&" : "?") + "_=" + E : "");
        }
        ((m.data && m.hasContent && m.contentType !== !1) || n.contentType) &&
          C.setRequestHeader("Content-Type", m.contentType),
          m.ifModified &&
            ((i = i || m.url),
            B.lastModified[i] &&
              C.setRequestHeader("If-Modified-Since", B.lastModified[i]),
            B.etag[i] && C.setRequestHeader("If-None-Match", B.etag[i])),
          C.setRequestHeader(
            "Accept",
            m.dataTypes[0] && m.accepts[m.dataTypes[0]]
              ? m.accepts[m.dataTypes[0]] +
                  ("*" !== m.dataTypes[0] ? ", " + on + "; q=0.01" : "")
              : m.accepts["*"]
          );
  ...
  B.ajaxSetup({
    ...
    B.ajaxPrefilter("json jsonp", function (t, n, r) {
      ...
      if (
        "jsonp" === t.dataTypes[0] ||
        (t.jsonp !== !1 && (ln.test(t.url) || (i && ln.test(t.data))))
      ) {
        var o,
          a = (t.jsonpCallback = B.isFunction(t.jsonpCallback)
            ? t.jsonpCallback()
            : t.jsonpCallback),
          s = e[a],
          l = t.url,
                  ...
                  try {
                    if (r && (i || 4 === l.readyState))
                      if (
                        ((r = t),
                        a &&
                          ((l.onreadystatechange = B.noop), cn && delete un[a]),
                        i)
                      )
    ...
    show: function (e, t, n) {
      ...
      for (var s = 0, l = this.length; l > s; s++)
        (o = this[s]),
          o.style &&
            ((a = o.style.display),
            !B._data(o, "olddisplay") &&
              "none" === a &&
              (a = o.style.display = ""),
            "" === a &&
              "none" === B.css(o, "display") &&
              B._data(o, "olddisplay", r(o.nodeName)));
      for (s = 0; l > s; s++)
        (o = this[s]),
          o.style &&
            ((a = o.style.display),
            ("" === a || "none" === a) &&
              (o.style.display = B._data(o, "olddisplay") || ""));
      return this;
    },
    hide: function (e, t, n) {
      ...
      for (var r = 0, o = this.length; o > r; r++)
        if (this[r].style) {
          ...
          "none" !== a &&
            !B._data(this[r], "olddisplay") &&
            B._data(this[r], "olddisplay", a);
        }
      ...
      custom: function (e, t, n) {
        ...
        (this.startTime = mn || a()),
          ...
          r() &&
            B.timers.push(r) &&
            !hn &&
            (hn = setInterval(o.tick, o.interval));
      },
      show: function () {
        ...
        return (
          1 / 0 == s.duration
            ...
            : ((n = r - this.startTime),
              ...
              (this.pos = B.easing[s.animatedProperties[this.prop]](
                this.state,
                n,
                0,
                1,
  ...
  (B.fn.offset =
    "getBoundingClientRect" in M.documentElement
      ? function (e) {
          ...
          var s = o.body,
            ...
            f =
              l.pageYOffset ||
              (B.support.boxModel && a.scrollTop) ||
              s.scrollTop,
            d =
              l.pageXOffset ||
              (B.support.boxModel && a.scrollLeft) ||
              s.scrollLeft,
            p = t.top + f - u,
            h = t.left + d - c;
          return { top: p, left: h };
      ...
      : function (e) {
          ...
          for (
            ...
            t !== s &&
            t !== a &&
            (!B.offset.supportsFixedPosition || "fixed" !== u.position);
            ...
            (n = l ? l.getComputedStyle(t, null) : t.currentStyle),
              ...
              t === r &&
                ...
                B.offset.doesNotAddBorder &&
                  (!B.offset.doesAddBorderForTableAndCells ||
                    !xn.test(t.nodeName)) &&
                  ((c += parseFloat(n.borderTopWidth) || 0),
                  (f += parseFloat(n.borderLeftWidth) || 0)),
                (i = r),
                (r = t.offsetParent)),
          ...
          return (
            ("relative" === u.position || "static" === u.position) &&
              ((c += s.offsetTop), (f += s.offsetLeft)),
            B.offset.supportsFixedPosition &&
              "fixed" === u.position &&
    ...
    (B.offset = {
      ...
      bodyOffset: function (e) {
        ...
        return (
          B.offset.initialize(),
          B.offset.doesNotIncludeMarginInBodyOffset &&
      ...
      setOffset: function (e, t, n) {
        ...
        var i,
          ...
          c =
            ("absolute" === r || "fixed" === r) &&
            B.inArray("auto", [l, u]) > -1,
          f = {},
          d = {};
        c
          ? ((d = a.position()), (i = d.top), (o = d.left))
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            e && !Tn.test(e.nodeName) && "static" === B.css(e, "position");
            ...
            ? ((a = n(o)),
              a
                ? "pageXOffset" in a
                  ...
                  : (B.support.boxModel && a.document.documentElement[i]) ||
                    a.document.body[i]
                : o[i])
            : null
          : this.each(function () {
        ...
        (B.fn[r] = function (e) {
          ...
          if (B.isWindow(i)) {
            var o = i.document.documentElement["client" + n],
              a = i.document.body;
            return (
              ("CSS1Compat" === i.document.compatMode && o) ||
              (a && a["client" + n]) ||
              o
            );
          }
...
!(function (e) {
  e.host = (function () {
    ...
    return (t =
      e.indexOf("https") > -1
        ? e + "//nie.res.netease.com"
        : e + "//res.nie.netease.com");
  })();
})(jQuery),
  !(function (e) {
    e.browser =
      ...
      (function () {
        var e = navigator.userAgent.toLowerCase(),
          ...
          r =
            ...
            a.exec(e) ||
            n.exec(e) ||
            (e.indexOf("compatible") < 0 && i.exec(e)) ||
            [];
        return {
          browser: r[1] || "",
          version: r[2] || "0",
  ...
  !(function () {
    jQuery.cookie = function (e, t, a) {
      ...
      if (
        a.expires &&
        ("number" == typeof a.expires || a.expires.toUTCString)
      ) {
        var s;
        "number" == typeof a.expires
          ? ((s = new Date()),
            s.setTime(s.getTime() + 24 * a.expires * 60 * 60 * 1e3))
          : (s = a.expires),
    ...
    (e.chainclude = function (t, a) {
      ...
      (e.chainclude.load = function (t, a) {
        if ("object" == typeof t && "undefined" == typeof t.length)
          for (var n in t) return e.include.load(n, a, t[n].callback);
      ...
      (e.include = function (t, a) {
        var n = e.include.luid++,
          i = function (t, i) {
            e.isFunction(t) && t(i),
              0 == --e.include.counter[n] && e.isFunction(a) && a();
          };
        if ("object" == typeof t && "undefined" == typeof t.length) {
        ...
        exist: function (t) {
          ...
          return (
            e("head script").each(function () {
              return /.css$/.test(t) && this.href == t
                ? (a = !0)
                : /.js$/.test(t) && this.src == t
                ? (a = !0)
                : void 0;
            }),
            a
    ...
    nie.site =
      ...
      (function () {
        ...
        return t
          ...
          : /^(www\.)?(\u68a6\u5e7b\u897f\u6e38|xn--owt49tjseb46a)\.(com|cn|net|\u4e2d\u56fd|xn--fiqs8s)$/i.test(
              e
            )
          ? "xyq"
          : /^(www\.)?(\u98de\u98de|xn--q35aa)\.(com|cn|net|\u4e2d\u56fd|xn--fiqs8s)$/i.test(
              e
            )
          ? "ff"
          : /^(www\.)?(\u5927\u8bdd\u897f\u6e38|xn--pss230cs2tifc)\.(com|cn|net|\u4e2d\u56fd|xn--fiqs8s)$/i.test(
              e
            )
          ? "xy2"
          : null;
      ...
      (nie.use = function (t, a) {
        var n = t.sort().toString(),
          i =
            e.host +
            "/comm/js/" +
            (0 != window.self.location.href.indexOf("http")
              ? "use.php?p=" + n + "&"
              : "cache/" + e.md5(n)) +
            ".js";
  ...
  !(function ($) {
    function unique(e) {
      for (var t, a = [], n = {}, i = 0; null != (t = e[i]); i++)
        n[t] || (a.push(t), (n[t] = !0));
      return a;
    }
    function filter(e, t) {
      for (var a = [], n = 0; n < e.length; n++)
        1 == t(e[n], n) && a.push(e[n]);
      return a;
    }
    function factoryProcess(e) {
      function t(e) {
        (_factoryList[e].canProcess = !0),
          ...
          _factoryList[e].name
            ? (window[_factoryList[e].name] = _defineList[
                _factoryList[e].name
              ] =
                _factoryList[e].factory() || _factoryList[e].name)
            : _factoryList[e].factory(),
          _factoryList[e + 1] && _factoryList[e + 1].canProcess && t(e + 1);
      }
      return 0 >= e
        ? (t(e), !0)
        : _factoryList[e - 1].did
        ? (t(e), !0)
        : ((_factoryList[e].canProcess = !0), !1);
    }
    var _defineList = {},
      _host = $.host + "/comm/js/",
      _nameHash = {
    ...
    (nie.define = function (e, t) {
      "string" != typeof e && ((t = e), (e = null)),
        ...
        (_factoryIndex += 1),
        _factoryList.push({ factory: t, name: e });
      var a = t.toString().match(/nie\.require\([^\)]+\)/g),
        n = "",
        i = 0;
      if ((e && (_defineList[e] = !0), !a || !a.length))
        return factoryProcess(t.__nieIndex);
      for (var r = 0; r < a.length; r++)
        a[r] = a[r].match(/\(([^\)]+)\)/i)[1].replace(/'|"/g, "");
      if (
        ((a = unique(a)),
      ...
      (nie.require = function (name) {
        return (
          (name = _defineList[name] || name),
          "string" != (typeof name).toLowerCase()
            ? name
            : eval("(" + name + ")")
        );
      }),
        ...
        url: {
          ...
          add: function (e, t) {
            var a = "http://clickgame.163.com/" + nie.config.site + "/" + e,
              n = t || null;
            nie.config.stats.url._data.push({ url: a, title: n }),
          ...
          addto: function (e, t, a) {
            var n =
                ...
                e,
              i = t || null;
            (a = a || window._ntes_nacc),
              nie.config.stats.url._data.push({ url: n, title: i, site: a }),
              nie.config.stats.loaded && nie.config.stats.url._run(n, i, a);
          },
          _cb: function () {
            for (
              var e = nie.config.stats.url._data, t = 0, a = e.length;
              a > t;
              t++
            )
              nie.config.stats.url._run(e[t].url, e[t].title, e[t].site);
          },
          _run: function (t, a, n) {
            e.isFunction(neteaseTracker) &&
              neteaseTracker(!0, t, a, n ? n : "clickgame");
          },
        },
      },
  ...
  (nie.util.addStyle = function (e) {
    var t;
    document.all
      ? ((t = document.createStyleSheet()), (t.cssText = e))
        ...
        if (null != nie.config.site)
          if ("undefined" != typeof t[nie.config.site]) a = n(nie.config.site);
            ...
            (i = nie.config.site.match(/([^.]+)\.baike/)),
              ...
              i && i.length > 1 && (a = n(i[1].split("-")[0])),
              null == a &&
                nie.config.site.split(".").length < 2 &&
                (a = n(nie.config.site));
          }
      ...
      null != a &&
        e.include("//analytics.163.com/ntes.js", function () {
          (nie.config.stats.loaded = !0),
            ...
            nie.config.stats.clickStats &&
              (nie.config.stats.clickStatsPrecent
                ? neteaseClickStat(nie.config.stats.clickStatsPrecent)
                : neteaseClickStat()),
...
var ADBase = (function (e) {
  ...
  function a(e) {
    for (var t = [], a = [], i = !!e[0].noCache, r = 0; r < e.length; r++)
      t.push(e[r].pos), a.push(e[r].callback);
    (t = t.join(",")),
      u({
        url: p.getData,
        data: "pos=" + t,
  ...
  function r(e, t) {
    for (var a in t)
      !e[a] || e[a].length < 1
        ...
        ? (e[a] = t[a])
        : (e[a] && e[a].length && (!t[a] || t[a].length < 1)) ||
          ((!t[a] || t[a].length < 1) &&
            (!e[a] || e[a].length < 1) &&
            (e[a] = []));
    return e;
  ...
  function c(e, t) {
    ...
    if (a) {
      ...
      l(".adbase-ctn").css(
        ...
        "url(" +
          l.host +
          "/comm/js/nie/util/img/error.png) center center no-repeat"
      );
...
!(function (e) {
  nie.util.topBar =
    nie.util.topBar ||
    function () {
      !nie.config.topBar.hasRun &&
        document.getElementById("NIE-topBar") &&
        ((nie.config.topBar.hasRun = !0),
        e.include(e.host + "/comm/nie.topBar/js/topBar.v2.last.js")),
        (document.getElementById("NIE-topBar") ||
          document.getElementById("NIE-topBar-include")) &&
          nie.util.addStyle(
            ".adbase-ctn{background:url(" +
              e.host +
              "/comm/js/nie/util/img/loading.png) center center no-repeat;}"
          );
    };
})(jQuery),
  !(function (e) {
      ...
      function () {
        ...
        if (t.length > 0 || a.length > 0) {
          var n = e.host + "/comm/NIE_copyRight/images/",
            ...
            d = "",
            b =
              "\u672c\u6e38\u620f\u9002\u5408$age\u5c81\u4ee5\u4e0a\u7684\u73a9\u5bb6\u8fdb\u5165\u3002<br />",
            y =
              "\u79ef\u6781\u5065\u5eb7\u7684\u6e38\u620f\u5fc3\u6001\u662f\u5065\u5eb7\u6e38\u620f\u7684\u5f00\u7aef\uff0c\u672c\u6e38\u620f\u6545\u4e8b\u60c5\u8282\u8bbe\u7f6e\u7d27\u51d1\uff0c\u8bf7\u60a8\u5408\u7406\u63a7\u5236\u6e38\u620f\u65f6\u95f4\uff0c\u907f\u514d\u6c89\u6eba\u6e38\u620f\u5f71\u54cd\u751f\u6d3b\uff0c\u6ce8\u610f\u81ea\u6211\u4fdd\u62a4\uff0c\u9632\u8303\u7f51\u7edc\u9677\u9631\u3002<br />",
            w =
              ' <a href="http://game.163.com/bs/ca_lianyun.html" target="_blank">\u8054\u8fd0\u63a8\u5e7f</a> -',
            k =
              '<a href="http://www.cogcpa.org" target="_blank">\u4e2d\u56fd\u7f51\u7edc\u6e38\u620f\u7248\u6743\u4fdd\u62a4\u8054\u76df\u4e3e\u62a5\u4e2d\u5fc3</a>',
            x = !1,
            v = "",
            _ = !1,
            C = "",
            ...
            A = j(
              ...
              31,
              n + "wen.png",
              "http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/toDetail/5F3BB7FDD27D4B01964F56E1FFBADD53"
            ),
            G = j(
              31,
              31,
              n + "wen.png",
              "http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/toDetail/700E4EB3C85B469E84A28595D0F16CFC"
            ),
            q =
              j(
                31,
                31,
                n + "wen.png",
                "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08c4b4e62fe014b523d7ba00a15"
              ) +
              j(
                31,
                35,
          ...
          switch (nie.config.copyRight.product) {
            case "xyq":
              (o =
                r + "\u30102005\u3011017\u53f7\uff082011\uff09C-RPG042\u53f7"),
                /^(www\.)?(\u68a6\u5e7b\u897f\u6e38|xn--owt49tjseb46a)\.(com|cn|net|\u4e2d\u56fd|xn--fiqs8s)$/i.test(
                  window.self.location.hostname
                ) &&
                  (d =
                    "<a href='http://www.miibeian.gov.cn' target='_blank'>\u7ca4ICP\u5907B2-20090191</a>"),
                (s = "\u7ca4\u7f51\u6587[2014]0636-236\u53f7"),
                (m = A);
              break;
            case "xyq.baike":
              ...
              (S = 1),
                ...
                (m =
                  ...
                  j(
                    ...
                    31,
                    n + "ccnt.png",
                    "http://182.131.21.137/ccnt-apply/publicservice/applyonline/product/gameBase!gameNetTag.action?oprBean.id=F35FC9BEF88A52AEE040007F01003007"
                  ));
              break;
            case "sg":
              (o = r + "[2010]W-SLG013\u53f7"),
            ...
            case "bw":
              (m =
                ...
                j(
                  ...
                  35,
                  n + "wen2.png",
                  "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08c514355d5015156fbbfb51851"
                )),
                (s = u),
            ...
            case "y3":
              (o = r + "(2013)C-CSG008\u53f7"),
                (s = "\u7ca4\u7f51\u6587[2014]0636-236\u53f7"),
                (h =
                  "\u65b0\u5e7f\u51fa\u5ba1[2016]785\u53f7<br />ISBN 978-7-89988-708-0"),
                (m = A);
              break;
            case "zh":
              ...
              (S = 1),
                (m =
                  ...
                  j(
                    ...
                    31,
                    n + "baolie.png",
                    "http://182.131.21.137/ccnt-apply/publicservice/applyonline/product/gameBase!gameNetTag.action?oprBean.id=9AF4AACBFF6B4C2EB731F2CDE6ABBF43"
                  )),
                (o = r + "(2014)C-RPG102\u53f7"),
                (s = "\u7ca4\u7f51\u6587[2014]0636-236\u53f7");
              break;
            ...
            case "fsqq":
              (g = !1),
                (_ = !0),
                (s = u),
                (C = "http://fsqq.163.com/userAgreement.html"),
                (R =
                  ' - <a href="' +
                  C +
                  '" target="_blank">\u7528\u6237\u534f\u8bae</a>');
              ...
              (s = u),
                (m =
                  ...
                  j(
                    ...
                    35,
                    n + "wen2.png",
                    "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08c54807eb00154939e92a615ac"
                  )),
                (z =
                  "\u676d\u5dde\u7f51\u6613\u96f7\u706b\u79d1\u6280\u6709\u9650\u516c\u53f8\u7248\u6743\u6240\u6709"),
                (o =
                  "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-RPG 1055 \u53f7"),
                (g = !1);
              break;
            case "gfxm":
              (s = u),
              ...
              (S = 1),
                (m =
                  ...
                  j(
                    ...
                    35,
                    n + "wen2.png",
                    "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08b54a4776a0154c7a856383626"
                  )),
                (s = u),
                (o =
                  "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-RPG 1694 \u53f7"),
                (z =
                  "\u676d\u5dde\u7f51\u6613\u96f7\u706b\u79d1\u6280\u6709\u9650\u516c\u53f8\u7248\u6743\u6240\u6709"),
                (k = "");
              break;
              ...
              (o =
                ...
                (m =
                  ...
                  j(
                    ...
                    35,
                    n + "wen2.png",
                    "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08c51af8c94015214ebc2b5400a"
                  )),
                (s = u),
                (_ = !0),
                (C = "http://game.163.com/sy/client/userAgreement2.html"),
              ...
              (s = u),
                (m =
                  ...
                  j(
                    ...
                    35,
                    n + "wen2.png",
                    "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08c51af8c940151c9217cfd30ad"
                  )),
                (o =
                  "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-SLG 1185 \u53f7"),
                (_ = !0),
                (C = "http://game.163.com/sy/client/userAgreement2.html"),
                (R =
                  ' - <a href="' +
              ...
              (o =
                ...
                (m =
                  ...
                  j(
                    ...
                    35,
                    n + "wen2.png",
                    "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08b548079b501549e9195bf3eda"
                  )),
                (s = u),
                (_ = !0),
                (C = "http://game.163.com/sy/client/userAgreement2.html"),
            ...
            case "dfw9":
              (o =
                "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-CSG3853\u53f7"),
                (s = u);
              break;
            case "bz":
              o =
                "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-RPG4280\u53f7";
              break;
            case "hit":
          ...
          var D =
              g &&
              /^\/($|index.html|boot.html)/.test(window.self.location.pathname),
            L = "";
          window.self.location.pathname.match(/\/xyz_\S+/i) &&
            ((D = !0), (s = u), (m = A)),
            /^\/($|index.html|tyfab.html)/.test(
              window.self.location.pathname
            ) &&
              "tianyu" == nie.config.copyRight.product &&
              ((D = !0), (p = 18), (d = "")),
            /^\/($|index.html|fab)/.test(window.self.location.pathname) &&
              "lzxxdn" == nie.config.copyRight.product &&
              (D = !0),
            "game" == nie.config.copyRight.product &&
              window.self.location.pathname.indexOf("/sy/client/") >= 0 &&
              ((m = ""), (s = "")),
          ...
          M[nie.config.copyRight.product] &&
            (B = B.replace(
              "http://www.leihuo.net/jiazhang.html",
              "http://game.163.com/jiazhang/"
            ));
          var T = s;
          if (D) {
            var E = "";
            "bz" == nie.config.copyRight.product &&
              (E = "\xa9CAPCOM U.S.A.,INC.2016 ALL RIGHTS RESERVED<br>"),
              "db" == nie.config.copyRight.product &&
                (E =
                  "\xa9VIRTUALTOYS Inc\uff0c\u7531\u5e7f\u5dde\u7f51\u6613\u8ba1\u7b97\u673a\u7cfb\u7edf\u6709\u9650\u516c\u53f8\u8fd0\u8425<br>"),
              ...
              (v =
                ...
                L +
                (o
                  ? '<a target="_blank" href="http://game.163.com/news/2010/6/9/442_216957.html">\u300a\u7f51\u7edc\u6e38\u620f\u7ba1\u7406\u6682\u884c\u529e\u6cd5\u300b</a>\u3000'
                  : "") +
                o +
                (s
                  ? "\u300a\u7f51\u7edc\u6587\u5316\u7ecf\u8425\u8bb8\u53ef\u8bc1\u300b" +
          ...
          if (t.length > 0) {
            (I[nie.config.copyRight.product] || T == u) &&
              ((o = ""), (s = ""), (k = ""));
            var N = D
              ? "width:" + (y ? 832 : 765) + "px;text-align:left;"
              : "width:100%;text-align:center;";
            ("bw" == nie.config.copyRight.product ||
              "qnm" == nie.config.copyRight.product) &&
              (N = D
                ? "width:" + (y ? 900 : 765) + "px;text-align:left;"
                : "width:100%;text-align:center;"),
              "xqn" == nie.config.copyRight.product &&
                (N = D
                  ? "width:" + (y ? 900 : 765) + "px;text-align:left;"
                  : "width:100%;text-align:center;"),
              (i +=
              ...
              (I[nie.config.copyRight.product] || T == u) &&
                (D
                  ? "xqn" == nie.config.copyRight.product &&
                    (B = B.replace("right:70px;", "right:50px;"))
                  : (B = B.replace(
                      "position:absolute;right:70px;top:38px;",
                      "position:relative;left:-173px;top:2px;"
                    )),
                (i += B),
    ...
    nie.util.union = nie.util.union || {
      ...
      processUrl: function () {
        ...
        if (e.inArray(this.url.raw, this.unionFabUrlList) >= 0)
          ...
          (this.url.req = n.req),
            n.hasOwnProperty("login") &&
              ((this.url.isUnion = !0), (this.url.urs = n.login)),
            n.hasOwnProperty("username") &&
              ((this.url.isUnion = !0), (this.url.urs = n.username)),
            n.hasOwnProperty("product") &&
              ((this.url.isUnion = !0), (this.url.product = n.product));
        }
      },
      setupUnion: function (t) {
        ...
        t.hasOwnProperty("0") && a(t[0]),
          t.hasOwnProperty("1") && (this.qUrsUnion.url = t[1]),
          t.hasOwnProperty("2") && n(t[2], this.url.urs),
          t.hasOwnProperty("3") && n(t[3], this.url.urs);
      },
    ...
    e(function () {
      nie.config.stats.defaultRun &&
        ...
        e(window).bind("load", function () {
          ...
          e.match(
            /\[an\serror\soccurred\swhile\sprocessing\sthis\sdirective\]/i
          ) && BJ_REPORT.report("include_error_" + window.location.href);
        }),
        setTimeout(function () {
    ...
    function t() {
      ...
      return (
        i && 1 > i && i > 0
          ...
          ? a.outerWidth > 0 &&
            a.innerWidth > 0 &&
            ((n.outerWidth = a.outerWidth),
            (n.innerWidth = a.innerWidth),
            (t = a.outerWidth / a.innerWidth))
