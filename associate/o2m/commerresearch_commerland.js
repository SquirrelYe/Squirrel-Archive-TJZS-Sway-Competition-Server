...
module.exports = {
    ...
    add: function (req, res) {
        co(function* () {
            var commerresearch1 = yield commerresearch.create({'id':req.query.commerresearch_id}); 
            var commerland1 = yield commerland.findById(req.query.commerland_id)  
            yield commerresearch1.setCommerland(commerland1) 
            .then(msg => {
                res.send(msg);
            })
        }).catch(function (e) {
    ...
    del: function (req, res) {
        co(function* () {
            var commerresearch1 = yield commerresearch.findById(req.query.commerresearch_id)   
            yield commerresearch1.setCommerland(null) 
            .then(msg => {
                res.send(msg);
            })
        }).catch(function (e) {
