...
router.use("/commerresearch_transaction", function (req, res) {
  ...
  if (req.query.judge == 3)
    commerresearch_transaction.find_commerresearch(req, res);
  if (req.query.judge == 4)
    commerresearch_transaction.find_transaction(req, res);
});
router.use("/commerresearch_industryyield", function (req, res) {
  ...
  if (req.query.judge == 3)
    commerresearch_industryyield.find_commerresearch(req, res);
  if (req.query.judge == 4)
    commerresearch_industryyield.find_industryyield(req, res);
});
...
router.use("/industryyield_commerresearch", function (req, res) {
  ...
  if (req.query.judge == 3)
    industryyield_commerresearch.findByCompany(req, res);
...
router.use("/commerresearch_commerland", function (req, res) {
  ...
  if (req.query.judge == 4)
    commerresearch_commerland.find_commerresearch(req, res);
...
router.use("/indusland_industryyield", function (req, res) {
  ...
  if (req.query.judge == 4)
    indusland_industryyield.find_industryyield(req, res);
});
